...
public abstract  class RefreshInterceptLayout extends RefreshBaseLayout {
    ...
    public RefreshInterceptLayout(Context context) {
        super(context);
    }

    public RefreshInterceptLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
